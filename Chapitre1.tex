...
L’échographie ultrarapide est une technique émergeante d’imagerie échographique reposant sur la capacité de contrôler tous les éléments de la sonde échographique. Grâce à cette technique, il est possible de remonter à l’orientation des myofibres et à l’anisotropie des tissus biologiques. On distinguera l'imagerie en tenseur de rétrodiffusion \cite{Papadacci2014} (BTI, \textit{Backscatter Tensor Imaging}) et \textit{Elastic Tensor Imaging} (ETI). Cette dernière sur les propriétés des ondes de cisaillement qui se propage plus rapidement dans le sens des fibres qu’entre les fibres \cite{Agger2020}. \\
