...
Le sang circule dans un sens unique et synchrone. Le cœur gauche propulse le sang riche en oxygène dans 
...
\begin{equation}
\nonumber
\ln{\left(\frac{S}{S_0}\right)}=\ -\gamma^2 \cdot G^2 \cdot\delta ^2 \cdot (\Delta-\frac{\delta}{3}) \cdot D =-\ b.\ D\
\end{equation}
